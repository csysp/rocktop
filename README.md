...
<img src="docs/diagrams/main.light.svg#gh-light-mode-only" alt="Core Flow" width="100%"/>
<img src="docs/diagrams/main.dark.svg#gh-dark-mode-only" alt="Core Flow" width="100%"/>

### Core Stack

<!-- Pre-rendered SVGs (light/dark) generated by GitHub Action -->
<img src="docs/diagrams/stack.light.svg#gh-light-mode-only" alt="Core Stack" width="100%"/>
<img src="docs/diagrams/stack.dark.svg#gh-dark-mode-only" alt="Core Stack" width="100%"/>
